...
//If arr[left] <= arr[right], this means that arr[right] is the max value found so far. This also means that maxLeft will be less than or equal to arr[right], 
 //which means that maxLeft will be boundry to the answer(res variable, in this solution), 
